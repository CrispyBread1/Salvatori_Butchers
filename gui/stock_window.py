...
from gui.components.stock_windows.goods_in_window import GoodsInWindow
...
class StockWindow(QMainWindow):
    ...
    def setup_ui(self, user=None):
        ...
        if user and user.admin:
            ...
            self.goods_in_button = QPushButton("Goods In", self)
            self.goods_in_button.clicked.connect(self.show_goods_in)
            ...
            self.nav_dashboard_layout.addWidget(self.goods_in_button)
            ...
            self.goods_in_window = GoodsInWindow()
            ...
            self.stacked_widget.addWidget(self.goods_in_window)
    ...
    def show_goods_in(self):
        self.stacked_widget.setCurrentWidget(self.goods_in_window)
        self.back_button.show() 
        # Hide Dashboard navigation buttons
        self.stock_take_button.hide()
        self.goods_in_button.hide()
