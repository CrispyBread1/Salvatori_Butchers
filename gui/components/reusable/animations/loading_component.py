...
class LoadingManager:
    ...
    def run_with_loading(self, task_function, on_complete=None, on_error=None, loading_text="Loading...", title="Please Wait", task_args=(), task_kwargs={}):
        ...
        Args:
            ...
            on_error: Callback function when task encounters an error
            loading_text: Text to display in the loading dialog
            title: Title of the loading dialog
        """
    ...
    def _show_error(self, error_message):
        self._close_dialog()
        print(f"Error occurred: {error_message}")  # Replace with your error handling
